...
const Dashboard = () => {
    ...
    if (member.organization.drops.length > 0) {
        return (
            <div className={dashStyles.dashboardContainer}>
                <SEO
                    title="Linkyo | Organization Dashboard"
                    description="View organization's dashboard"
                    name="Linkyo"
                    type="website"
                />
                {/* Header */}
                <header className={dashStyles.headerClass}>
                    <div className={dashStyles.header}>
                        <h1 className={dashStyles.headerTitle}>
                            Product Dashboard
                        </h1>
                ...
                <div className={dashStyles.statsGridContainer}>
                    {stats.map((stat, index) => (
                        <div key={index} className={dashStyles.Grids}>
                            <h3 className={dashStyles.gridTitle}>
                                {stat.title}
                            </h3>
                            <p className={dashStyles.gridValue}>{stat.value}</p>
                            <span className={dashStyles.gridChange}>
                ...
                <div className={dashStyles.mainContent}>
                    ...
                    <div className={dashStyles.chartContainer}>
                        <div className={dashStyles.chartPrepare}>
                            <h2 className={dashStyles.chartTitle}>
                    ...
                    <div className={dashStyles.dropList}>
                        <h2 className={dashStyles.dropOverview}>
                            Products Overview
                        </h2>
                        <div className={dashStyles.spaces}>
                            {products.map((product) => (
                                ...
                                >
                                    <div>
                                        <h3 className={dashStyles.dropName}>
                                            {product.name}
                                        </h3>
                                        <p className={dashStyles.Stock}>
                                            Stock: {product.stock}
                                        </p>
                                    </div>
                                    <div className={dashStyles.dropValues}>
                                        <p className={dashStyles.dropPrice}>
                                            ${product.price}
                                        </p>
                                        <p className={dashStyles.dropSales}>
                                            {product.sales} sold
                                        </p>
                                    </div>
                                </div>
        ...
        return (
            <div className={dashStyles.dropsNotFoundContainer}>
                <SEO
                    title="Linkyo | Organization Dashboard"
                    description="View organization's dashboard"
                    name="Linkyo"
