            ...
            <div className = "final-form" >
                <div id = "form-card" >
                    <div id = "title-div" >
                        ...
                        <div id = "title-desc" > Let's setup your profile first, you can edit it later </div>
                    </div>
                    ...
                    <div className='Img-about-class'>
                        <div className = "upload-img-class">  
                            <img id="profile-img" src={svgs["img-upload1.svg"]}></img>
                            <button type="button" id = "upload-button"> Upload profile Picture </button>
                        </div>
                ...
                <button type ="button" className="finishButton" onClick="">Finish</button>
            </div>
            </div>
        </>
    );
