...
export function isDataFromOurDatabase(databaseResponse) {
    if (
        "_id" in databaseResponse &&
        "__v" in databaseResponse &&
        databaseResponse._id.length > 0
    ) {
        return true;
    } else {
        return false;
 ...
 * Credit and source: https://github.com/JeetSaru/Telephone-Input-Field-With-Country-Code-Flag/blob/main/script.js
 * @type {Array}
 */
