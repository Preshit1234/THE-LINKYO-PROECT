        ...
        <div className={ userListStyles.ParentList }>
            <div className={ userListStyles.ParentListLeft }>
                <div className={ userListStyles.ImgClass }>
                    <img className={ userListStyles.ProfilePic } src={images["dummyprofilepic.png"]}/>
                </div>
                <div className={ userListStyles.TitleClass }>
                    <div className={ userListStyles.Title }> Patrick Batemen </div>
                    <div className={ userListStyles.Role }> Vice President, Pierce & Pierce</div>
                </div>
