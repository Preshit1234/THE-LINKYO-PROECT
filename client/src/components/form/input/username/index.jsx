...
/**
 * A component that displays the "Username" label and a text input field. And handles the input validation.
 *
 * @component
 * @example
 * return <Username componentValue="" componentIdPrefix="" componentRef="" />
 *
